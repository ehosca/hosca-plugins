...
| Plugin | Description |
|--------|-------------|
| [**sql&#8209;audit&#8209;skill**](plugins/sql-audit-skill) | Audit a SQL Server database against Joe Celko's *SQL Programming Style* — read-only catalog queries via `sqlcmd`, severity-tiered findings report. Windows-only. |
